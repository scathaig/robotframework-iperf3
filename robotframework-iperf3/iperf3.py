...
class Iperf3(object):
    ...
    | python3 -m robotframework-iperf3 [-a <address>] [-p <port>]
    ...
    def start_server(self, server_port=None, bind_address=None):
        ...
        self.server = subprocess.Popen(shlex.split(command), stdout=subprocess.DEVNULL, stderr=subprocess.STDOUT)
    ...
    def stop_server(self):
        """
        Stops a running iPerf3 server which was started by this library instance.
        """
        try:
            self.server.kill()
